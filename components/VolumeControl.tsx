  ...
  if (sliderRef.current) {
    sliderRef.current.style.background = `
      linear-gradient(
        to right,
        rgba(255, 79, 110, 1) 0%,
        rgba(255, 79, 110, 0.8) ${value / 2}%,
        rgba(255, 79, 110, 0.6) ${value}%,
        rgba(255, 79, 110, 0.2) 75%,
    ...
    <div className="flex items-center gap-3 w-[160px]">
      ...
      <div className="flex-1 relative group">
        <input
          ...
          style={{
  background:
    "linear-gradient(to right, rgba(255, 79, 110, 1) 0%, rgba(255, 79, 110, 0.8) 25%, rgba(255, 79, 110, 0.6) 50%, rgba(255, 79, 110, 0.2) 75%, rgba(255,255,255,0.1) 100%)",
}}
